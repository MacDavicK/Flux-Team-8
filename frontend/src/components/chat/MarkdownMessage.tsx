  ...
  return (
    <ReactMarkdown
      components={{
        ...
        h3: ({ children }) => <h3 className="font-medium text-sm mt-1.5 mb-0.5">{children}</h3>,
        code: ({ children }) => <code className="bg-black/5 rounded px-1 py-0.5 text-xs font-mono">{children}</code>,
